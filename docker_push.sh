...
docker push "$DOCKER_USERNAME"/prueba:latest
docker tag "$DOCKER_USERNAME"/prueba:latest "$DOCKER_USERNAME"/prueba:"$VERSION"
docker push "$DOCKER_USERNAME"/prueba:"$VERSION"
